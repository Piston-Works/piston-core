...
import org.pistonworks.core.common.event.playerevent.PlayerMoveEventImpl;
...
public class EventFactory
{
    ...
    public static PlayerMoveEvent createPlayerMoveEvent(Player player, Position newPosition,
                                                        Position oldPosition,
                                                        org.pistonworks.core.api.model.Orientation newOrientation,
                                                        org.pistonworks.core.api.model.Orientation oldOrientation)
    {
        return new PlayerMoveEventImpl(player, newPosition, newOrientation, oldPosition, oldOrientation);
    }
}
